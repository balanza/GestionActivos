...
public class AccionBajaPanelResumen extends PanelResumen<AccionBaja> {


	
	public AccionBajaPanelResumen(DispositivoDAO dao) {
		super(new AccionBajaDataTableModel(), dao);
	}
	...
	protected void setRenders(){
		try {
			...
			datatable.getColumnModel().getColumn(3).setCellEditor(new CalendarCellEditor());
